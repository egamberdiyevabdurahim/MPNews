...
class CategoryModel(UsefulModel, models.Model):
...
class TagModel(UsefulModel, models.Model):
...
class NewsModel(UsefulModel, models.Model):
...
class NewsCollectionModel(UsefulModel, models.Model):
    types = (
        ("carousel", "carousel"),
...
class ContactModel(UsefulModel, models.Model):
...
class NewsLetterModel(UsefulModel, models.Model):
    email = models.EmailField()
